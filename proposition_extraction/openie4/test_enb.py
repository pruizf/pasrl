"""Tests applying OIE4 to ENB corpus"""
...
def cross_oie_and_domain_infos(res, preds, actors, cf):
    ...
    #TODO: this is faulty cos you can also look for the seen predicate in the
    # domain predicates, which will give you light verbs (e.g. look to find each
    # verbal_preds["rep"] inside the seen predicate, and you'll find "express concern"
    # as a seen predicate. Can then with a rule retag that as "oppose"
...
def main(cf=cfg):
    ...
    myactors = mdd.parse_actors_simple()
